...
import AfterFeed from "./afterFeed";
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-row justify-center pr-40">
        <div className="flex flex-col items-center justify-center">
          <div className="w-2/3 aspect-square relative">
            <img className="w-50 h-50 object-cover" src="smilepet.png" />
          </div>
        </div>
      ...
      <div className="flex flex-row gap-2 justify-center">
        ...
        <img
          src="https://cdn3d.iconscout.com/3d/premium/thumb/chicken-leg-7266604-5972485.png?f=webp"
          className="w-20 h-20"
        />
